...
<?php include('header.php'); ?>
    ...
    <div class="container">
        ...
        <div class="image"><img src="../img/product/2.png" alt=""></div>
        <br><br><br>
        <main style="padding-left: 5%;">
            <h1>苦橙葉單方精油</h1>
            <br><br>
            <div class="text" style="float: left; width: 65%;">
                <h3 style="font-weight: bold;">自然的活力</h3>
                <br>
                <p>「苦橙葉單方精油」是大自然賦予我們的禮物，它帶有苦橙葉的原生能量。<br>
                    這款精油的香氣充滿了活力和清新，是一種自然的提神劑，能夠讓您在疲勞時恢復精力。
                </p><br>
                <h3 style="font-weight: bold;">提振精神</h3>
                <br>
                <p>這瓶精油的香氣能夠提振您的精神，使您感到焕然一新。<br>
                    在繁忙的生活中，只需幾滴精油的香氣，您便能夠感受到內在的力量和活力，為每一天注入新的動力。</p>
                <br>

                <h3 style="font-weight: bold;">平衡情緒</h3>
                <br>
                <p>「苦橙葉單方精油」不僅能夠提升精神，還能夠平衡情緒。<br>
                    它的香氣具有舒緩的效果，能夠幫助您紓解壓力和焦慮，讓您心情平靜而愉悅。</p>
                <br>
                <h3 style="font-weight: bold;">多重用途</h3>
                <br>
                <p>這款精油具有多重用途，可以在精油燈中使用、按摩油中混合，甚至可以加入您的沐浴中。<br>
                    不論是在家中創造愉悅的氛圍，還是在放鬆時享受香氣，它都能成為您的最佳選擇。</p>
                <br>
                <h3 style="font-weight: bold;">自然的活力，自信的魅力</h3>
                <br>
                <p>「苦橙葉單方精油」是一個代表自然能量的精華寶藏。<br>
                    透過它的香氣和能量，您將感受到活力的喚醒，成為自己最自信的魅力展現。<br>
                    選擇「苦橙葉單方精油」，選擇自然的活力，讓您的日常充滿清新和動力。<br>
                    它將成為您身心平衡的伙伴，帶來自然的能量和愉悅。
                </p>
