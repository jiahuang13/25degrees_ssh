...
<?php include('header.php'); ?>
    ...
    <div class="container">
            ...
            <div class="image"><img src="../img/product/9.png" alt=""></div>
            <br><br><br>
            <main style="padding-left: 5%;">
                <h1>蠟燭 | 天海相接</h1>
                <br><br>
                <div class="text" style="float: left; width: 65%;">
                    <h3 style="font-weight: bold;">天地之間的奇幻邂逅 Meeting of Sea and Sky</h3>
                    <br>
                    <p>透過「天海相接」香氛蠟燭，讓您感受到天地相接的神秘與和諧。
                        </p><br>
                    <h3 style="font-weight: bold;">香氛特色</h3>
                <br>
                <p>「天海相接」蠟燭的香氣仿佛是一場天地之間的對話，融合了潔淨的海風、天空的明亮和海洋的澎湃。<br>
                    這款香氛猶如一場穿越天際和海浪的奇幻之旅，帶您靠近大海，俯瞰遼闊的天際。</p>
<br>
                    <h3 style="font-weight: bold;">壯闊美景</h3>
                    <br>
                    <p>這款蠟燭將壯闊美景引入您的生活空間。<br>
                        「天海相接」蠟燭的香氣讓您彷彿置身於天地相接的界線上，<br>
                        感受著天空與海洋的融合，讓您的空間充滿壯麗和神秘。
            </div>    
