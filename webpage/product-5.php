...
<?php include('header.php'); ?>
    ...
    <div class="container">
            ...
            <div class="image"><img src="../img/product/5.png" alt=""></div>
            <br><br><br>
            <main style="padding-left: 5%;">
            <h1>柚木沐浴皂3件組</h1>
            <br><br>
            <div class="text" style="float: left; width: 65%;">
                <h3 style="font-weight: bold;">柚木清香</h3>
                <br>
                <p>「柚木沐浴皂3件組」蘊含柚木的精華，散發著清新、明亮的香氣。<br>
                    每一次的使用都能讓您感受到水果般的清新氛圍，讓沐浴成為一場身心愉悅的旅程。
                </p><br>
                <h3 style="font-weight: bold;">溫和清潔</h3>
                <br>
                <p>這三款沐浴皂均採用溫和的配方，能夠溫柔地潔淨肌膚，同時不破壞肌膚的油水平衡。<br>
                    您的肌膚將感受到徹底的清潔，同時保持水分與柔軟。</p>
                <br>
                <h3 style="font-weight: bold;">保濕滋潤</h3>
                <br>
                <p>所含的保濕成分，能夠在清潔的同時為肌膚注入水分和營養。<br>
                    您的肌膚將在沐浴後感受到柔軟滋潤，充滿光彩。</p>
            </div>    

                <div class="buy" style="float: right; width: 35%; text-align: center;">
                    <del>NT$680</del><br><br>
                <p> NT$510
                        <br><br>
                        數量
                    </p>
