...
<?php include('header.php'); ?>
    ...
    <div class="container">
            ...
            <div class="image"><img src="../img/product/6.png" alt=""></div>
            <br><br><br>
            <main style="padding-left: 5%;">
                <h1>保濕修護乳霜</h1>
                <br><br>
                <div class="text" style="float: left; width: 65%;">
                    <h3 style="font-weight: bold;">深層滋潤，呵護肌膚的極致柔軟</h3>
                    <br>
                    <p>蘊含豐富的保濕成分，能夠深層滋潤肌膚，令乾燥的肌膚瞬間回復水潤。<br>
                        乳霜的質地濃郁卻不油膩，輕輕一抹即可感受到肌膚的柔軟與舒適。
                    </p><br>
                    <h3 style="font-weight: bold;">長效保濕</h3>
                    <br>
                    <p>這款乳霜不僅在塗抹時提供肌膚所需的水分，更能夠長效保持肌膚的水油平衡。<br>
                        乳霜在肌膚表面形成一層保護膜，鎖住水分，讓您的肌膚持久保持濕潤狀態。</p>
                    <br>
    
                        <h3 style="font-weight: bold;">修護與舒緩</h3>
                    <br>
                    <p>不僅能保濕，更能夠修護受損的肌膚，舒緩不適。<br>
                        乳霜中的成分有助於修復肌膚屏障，增強肌膚的抵抗力，使肌膚更加健康。</p>
                        <br>
                    <h3 style="font-weight: bold;">柔軟光澤</h3>
                    <br>
                    <p>乾燥紋路將被淡化，取而代之的是煥發光采的肌膚。<br>
                        您的肌膚將更加有彈性，充滿年輕活力。</p>
                    <br>
                    <h3 style="font-weight: bold;">自信從肌膚開始</h3>
                    <br>
                    <p>「我們深信，自信源自健康的肌膚。<br>
                        持續的使用，您將看到肌膚的改變，自信光澤散發而出，成為自己最美的風景。<br>
                    </p>
            </div>    
