...
<?php include('header.php'); ?>
    ...
    <div class="container">
            ...
            <div class="image"><img src="../img/product/4.png" alt=""></div>
            <br><br><br>
            <main style="padding-left: 5%;">
            <h1>溫和植萃沐浴組</h1>
            <br><br>
            <div class="text" style="float: left; width: 65%;">
                <h3 style="font-weight: bold;">天然呵護，完整身心的純淨體驗</h3>
                <br>
                <p>集合了多款天然產品的組合，為您帶來純淨的沐浴享受，從頭到腳呵護您的肌膚。<br>
                    這個特別的組合包含了浴鹽、沐浴皂、毛巾和沐浴刷，為您打造一場身心的清新之旅。
                </p><br>
                <h3 style="font-weight: bold;">溫和的清潔</h3>
                <br>
                <p>組合中的沐浴皂溫和潔淨，能夠有效去除污垢和雜質，同時保護肌膚的水油平衡。<br>
                    搭配柔軟的毛巾，您的沐浴體驗將更加舒適。</p>
                <br>

                    <h3 style="font-weight: bold;">放鬆的沐浴時光</h3>
                <br>
                <p>將一些浴鹽加入沐浴水中，讓您享受放鬆的泡澡時光。<br>
                    浴鹽能夠舒緩肌膚，為您帶來舒適的身心體驗，讓您的沐浴成為一場寧靜的假期。</p>
                    <br>
                <h3 style="font-weight: bold;">完整的護理</h3>
                <br>
                <p>沐浴刷是組合的最後一環，能夠幫助您輕輕去除角質，促進血液循環，讓肌膚更加細緻光滑。<br>
                    結合所有產品的使用，您將獲得一個完整的護理體驗。</p>
            </div>    
